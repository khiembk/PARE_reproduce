...
def load_pde(root, batch_size, dataset='1DCFD', valid_split=-1, num_workers=4):
    ...
    if dataset == 'Burgers':
        root = '/mnt/disk2/khiemtt/CrossModality/src/PDE_dataset/1D/Burgers'
        ...
        #root = '/run/determined/workdir/shared_fs/data/PDEBench'
        root = '/mnt/disk2/khiemtt/CrossModality/src/PDE_dataset/1D/Advection/Train'
        ...
        root = '/mnt/disk2/khiemtt/CrossModality/src/PDE_dataset/1D/ReactionDiffusion/Train'
